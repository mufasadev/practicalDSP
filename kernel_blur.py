...
# show()
# imshow(cv2.filter2D(img, -1, matrix))
# show()
#
...
# show()
#
# imshow(procImageUsingKernel(rgb2gray(img), kernel_edge_detect1))
# show()
#
# imshow(procImageUsingKernel(rgb2gray(img), kernel_edge_detect2))
# show()
